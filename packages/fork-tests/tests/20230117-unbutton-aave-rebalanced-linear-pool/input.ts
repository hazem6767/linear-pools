...
const BaseVersion = { version: 1, deployment: '20230117-unbutton-aave-rebalanced-linear-pool' };
...
export default {
  ...
  WETH,
  FactoryVersion: JSON.stringify({ name: 'UnbuttonAaveLinearPoolFactory', ...BaseVersion }),
  PoolVersion: JSON.stringify({ name: 'UnbuttonAaveLinearPool', ...BaseVersion }),
